      ...
      <InCard>
        <Card
          ...
          <DetaylsInLineL>|</DetaylsInLineL>*/}
            ...
            {showDetails ? <Button onClick={() => setShowDetails(false)}><AiOutlineMinusCircle></AiOutlineMinusCircle> להסתרת פרטי משרה</Button> : <Button onClick={() => (setShowDetails(true))} >  <AiOutlinePlusCircle></AiOutlinePlusCircle>לצפיה בפרטי המשרה</Button>}
            {showDetails &&
              (
                <div>
                  <p>דרישות התפקיד:</p>
